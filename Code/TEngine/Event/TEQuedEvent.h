...
namespace TE::Event {
  ...
  template <typename EventT> class QuedEvent : public QuedEventBase {
  public:
  ...
  template <typename EventT> TE::Event::QuedEvent<EventT>::QuedEvent(EventT &event)
  ...
  template <typename EventT> const std::type_info *TE::Event::QuedEvent<EventT>::GetTypeInfo() {
    return m_typeInfo;
  }
}
