...
TE::Graphics::GraphicsObject::GraphicsObject(I32 objectId,
                                             Enum type,
...
Enum TE::Graphics::GraphicsObject::GetType() { return m_type; }
...
I32 TE::Graphics::GraphicsObject::GetObjectId() const { return m_objectId; }
