...
TE::Game::GameSystem::GameSystem(U32 systemId, const std::string &systemName, TE::Engine::EngineRoot &engine)
    : m_systemId(systemId),
      m_systemName(systemName) {
}

U32 TE::Game::GameSystem::GetSystemId() {
    return m_systemId;
}

const std::string &TE::Game::GameSystem::GetSystemName() {
    return m_systemName;
}
...
TE::Engine::SystemUPtr TE::Game::GameSystemFactory::Generate(U32 systemId, Engine::EngineRoot &engine, std::vector<Core::Value> &values) {
