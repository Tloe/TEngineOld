...
namespace TE::Network {
  ...
  class NetworkObject : public Engine::SystemObject, public Event::EventHandler {
  public:
    struct Values {
      enum { SubscribeTranslationEvent, SubscribeScaleEvent, SubscribeOrientationEvent };
    };
  ...
  using NetworkObjectWPtr = std::weak_ptr<NetworkObject>;
}
