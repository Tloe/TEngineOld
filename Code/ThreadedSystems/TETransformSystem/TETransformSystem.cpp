...
TE::Transform::TransformSystem::TransformSystem(U32 systemId,
...
U32 TE::Transform::TransformSystem::GetSystemId() { return m_systemId; }

const std::string &TE::Transform::TransformSystem::GetSystemName() { return m_systemName; }
...
TE::Transform::TransformSystemFactory::Generate(U32 systemId,
