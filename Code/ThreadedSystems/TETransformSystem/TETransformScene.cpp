...
TE::Engine::SystemTask *TE::Transform::TransformScene::GetSystemTask() { return nullptr; }

TE::Engine::SystemObjectSPtr
TE::Transform::TransformScene::CreateSystemObject(const std::string &objectType, I32 objectId) {
