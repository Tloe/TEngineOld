...
namespace TE
{
	...
	namespace SceneGraph
	{
		...
		public:
			...
			enum 
			{
				CAMERAPLANES_FRUSTRUM = 6,
				CAMERAPLANES_WORLD_MAX = 32
			};
			...
			void SetFrustrum(Real rightMin, Real rightMax,
							Real upMin, Real upMax,
							Real directionMin, Real directionMax);
			...
			void GetFrustrum(Real& rightMin, Real& rightMax,
				Real& upMin, Real& upMax,
				Real& directionMin, Real& directionMax) const;

			bool GetSymetricFrustrum(Real& upFovDegrees, Real& aspectRatio, Real& directionMin, Real& directionMax) const;
