...
namespace TE
{
	namespace Lua
	{
		...
		public:
			ClassFunction(State & state, const std::string & name, const std::string & metatableName, FunctionType function);
			ClassFunction(State & state, const std::string & name, const std::string & metatableName, Ret(*function)(Args...));
		...
		public:
			ClassFunction(State & state, const std::string & name, const std::string & metatableName, FunctionType function);
			ClassFunction(State & state, const std::string & name, const std::string & metatableName, void(*function)(Args...));
		...
		template <int N, typename ClassT, typename Ret, typename... Args>
		TE::Lua::ClassFunction<N, ClassT, Ret, Args...>::ClassFunction(State & state, const std::string & name, const std::string & metatableName, FunctionType function)
			: m_state(state), m_metatableName(metatableName), m_function(function)
		{
		...
		template <int N, typename ClassT, typename Ret, typename... Args>
		TE::Lua::ClassFunction<N, ClassT, Ret, Args...>::ClassFunction(State & state, const std::string & name, const std::string & metatableName, Ret(*function)(Args...))
		...
		{
			ClassT* pointer = static_cast<ClassT*>(luaL_checkudata(m_state(), 1, m_metatableName.c_str()));
		...
		//specialization 
		template <typename ClassT, typename... Args>
		TE::Lua::ClassFunction<0, ClassT, void, Args...>::ClassFunction(State & state, const std::string & name, const std::string & metatableName, FunctionType function)
			: m_state(state), m_metatableName(metatableName), m_function(function)
		{
			lua_pushlightuserdata(state(), (void *)static_cast<BaseFunction *>(this));
			lua_pushcclosure(state(), &LuaDispatcher, 1);
		...
		template <typename ClassT, typename... Args>
		TE::Lua::ClassFunction<0, ClassT, void, Args...>::ClassFunction(State & state, const std::string & name, const std::string & metatableName, void(*function)(Args...))
			: ClassFunction(state, name, metatableName, FunctionType{ function })
		{
