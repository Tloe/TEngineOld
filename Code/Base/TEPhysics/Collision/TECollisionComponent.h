...
namespace TE
{
	...
	namespace Intersection { struct Plane; }
	...
	namespace CollisionDetection
	{
		...
		/*public:
			...
			bool CollisionCheckFull(CollisionComponent &other, Intersection::ContactSet &contactSet, Real dt = Math::Base<Real>::REAL_ZERO,
		...
		private:
			bool									m_isPlane;
			I32										m_componentId;
			Memory::Pointer0<Intersection::BSphere>	m_enclosingVolume;
