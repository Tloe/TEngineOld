...
const std::string TE::Render::APIMapping::s_layoutSemantic[] = {"POSITION", "COLOR", "TEXTURE"};
...
const D3D11_USAGE TE::Render::APIMapping::s_bufferUsage[] = {D3D11_USAGE_IMMUTABLE,
                                                             D3D11_USAGE_DYNAMIC};
