...
namespace TE::SceneGraph {
  class FogState : public GlobalState {
    enum { DENSITYFN_LINEAR, DENSITYFN_EXP, DENSITYFN_EXPSQR, DENSITYFN_COUNT };

    enum { APPLYFN_PER_VERTEX, APPLYFN_PER_PIXEL, APPLYFN_COUNT };
    ...
    virtual I32 GetGlobalSateType() const { return STATE_FOG; }
