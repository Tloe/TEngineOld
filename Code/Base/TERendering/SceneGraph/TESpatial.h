...
namespace TE::SceneGraph {
  ...
  class Spatial {
  public:
    using RenderablePtrList = std::list<TE::SceneGraph::Renderable *>;

    Spatial();
    virtual ~Spatial();

    // void UpdateRenderState(std::stack< Memory::Pointer0< GlobalState > >* stateStack =
    // NULL, std::vector< Memory::Pointer0< Light > >* lightStack = NULL); void
    // SetGlobalState (Memory::Pointer0<GlobalState> globalState); GlobalState*
    // GetGlobalState(I32 stateType); void RemoveGlobalState(I32 stateType); void
  ...
  protected:
    /*void PropagateStateFromRoot(std::stack< Memory::Pointer0< GlobalState > >* stateStack,
    std::vector< Memory::Pointer0< Light > >* lightStack); virtual void
    UpdateRenderStateLocal(std::stack< Memory::Pointer0< GlobalState > >* stateStack,
    std::vector< Memory::Pointer0< Light > >* lightStack) = 0; void PushState(std::stack<
    Memory::Pointer0< GlobalState > >* stateStack, std::vector< Memory::Pointer0< Light > >*
    lightStack); void PopState(std::stack< Memory::Pointer0< GlobalState > >* stateStack,
