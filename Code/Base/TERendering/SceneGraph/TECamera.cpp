...
TE::SceneGraph::Camera::Camera(bool isPerspective) : m_isPerspective(isPerspective) {
#if TE_DX11
...
void TE::SceneGraph::Camera::SetOrientation(const Math::Vector3D<Real> &direction,
...
const TE::Math::Vector3D<Real> &TE::SceneGraph::Camera::GetPosition() const { return m_position; }

const TE::Math::Vector3D<Real> &TE::SceneGraph::Camera::GetDirection() const { return m_direction; }

const TE::Math::Vector3D<Real> &TE::SceneGraph::Camera::GetUp() const { return m_up; }

const TE::Math::Vector3D<Real> &TE::SceneGraph::Camera::GetRight() const { return m_right; }

Real TE::SceneGraph::Camera::GetDirectionMin() const { return m_directionMin; }

Real TE::SceneGraph::Camera::GetDirectionMax() const { return m_directionMax; }

Real TE::SceneGraph::Camera::GetUpMin() const { return m_upMin; }

Real TE::SceneGraph::Camera::GetUpMax() const { return m_upMax; }

Real TE::SceneGraph::Camera::GetRightMin() const { return m_rightMin; }

Real TE::SceneGraph::Camera::GetRightMax() const { return m_rightMax; }

void TE::SceneGraph::Camera::SetFrustrum(Real rightMin,
                                         Real rightMax,
                                         Real upMin,
                                         Real upMax,
                                         Real directionMin,
...
void TE::SceneGraph::Camera::SetFrustrum(Real upFovRadians,
                                         Real aspectRatio,
                                         Real directionMin,
                                         Real directionMax) {
    m_directionMin            = directionMin;
...
void TE::SceneGraph::Camera::GetFrustrum(Real &rightMin,
                                         Real &rightMax,
                                         Real &upMin,
                                         Real &upMax,
                                         Real &directionMin,
...
bool TE::SceneGraph::Camera::GetSymetricFrustrum(Real &upFovDegrees,
                                                 Real &aspectRatio,
                                                 Real &directionMin,
                                                 Real &directionMax) const {
    if (m_rightMin == -m_rightMax && m_upMin == -m_upMax) {
        ...
        upFovDegrees =
            Math::Base<Real>::REAL_TWO * Math::Base<Real>::Atan(tmp) * Math::Base<Real>::RAD_TO_DEG;
...
unsigned TE::SceneGraph::Camera::GetPlaneStateBits() const { return m_planeStateBits; }
...
void TE::SceneGraph::Camera::PopPlane() { m_cullingPlanes.pop_back(); }
