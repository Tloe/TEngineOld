    ...
    namespace Math {
        ...
        class Quaternion {
          public:
            ...
            Quaternion(const Quaternion &src) : x(src.x),
                                                y(src.y),
                                                z(src.z),
                                                w(src.w) {}
        ...
        template <>
        inline const TE::Math::Quaternion<F32> TE::Math::Quaternion<F32>::QUATERNION_IDENTITY = Quaternion<F32>{0.0f, 0.0f, 0.0f, 1.0};
        template <>
        inline const TE::Math::Quaternion<F64> TE::Math::Quaternion<F64>::QUATERNION_IDENTITY = Quaternion<F64>{0.0, 0.0, 0.0, 1.0};

        template <>
        inline const TE::Math::Quaternion<F32> TE::Math::Quaternion<F32>::QUATERNION_INVALID = Quaternion<F32>{0.0f, 0.0f, 0.0f, 0.0};
        template <>
        inline const TE::Math::Quaternion<F64> TE::Math::Quaternion<F64>::QUATERNION_INVALID = Quaternion{0.0, 0.0, 0.0, 0.0};
    }
}
