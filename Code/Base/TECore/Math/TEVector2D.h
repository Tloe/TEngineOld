    ...
    namespace Math {
        ...
        class Vector2D {
          public:
            ...
            Vector2D(const Vector2D &src) : x(src.x),
                                            y(src.y) {}

            Vector2D(Real nx, Real ny) : x(nx),
                                         y(ny) {}
        ...
        template <>
        inline const TE::Math::Vector2D<F64> TE::Math::Vector2D<F64>::VECTOR2D_ZERO(0.0, 0.0);
        ...
        template <>
        inline const TE::Math::Vector2D<F64> TE::Math::Vector2D<F64>::VECTOR2D_ONE(1.0, 1.0);
    }
}
