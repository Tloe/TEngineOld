...
TE::Lua::Table::~Table() { luaL_unref(m_state(), LUA_REGISTRYINDEX, m_luaReference); }
...
void TE::Lua::Table::PushToStack() { lua_rawgeti(m_state(), LUA_REGISTRYINDEX, m_luaReference); }
