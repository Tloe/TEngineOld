...
namespace TE::Lua {
  ...
  template <typename ClassT, typename... Args> class Constructor : public BaseFunction {
  public:
  ...
  template <typename ClassT, typename... Args> I32 Constructor<ClassT, Args...>::Execute() {
