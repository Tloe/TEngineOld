...
namespace TE::Lua {
  ...
  template <int N, typename ClassT, typename Ret, typename... Args> class ClassFunction
      : public BaseFunction {
  ...
  template <typename ClassT, typename... Args> class ClassFunction<0, ClassT, void, Args...>
      : public BaseFunction {
  ...
  ClassT *TE::Lua::ClassFunction<N, ClassT, Ret, Args...>::GetTPointer() const {
    ClassT *pointer =
        static_cast<ClassT *>(luaL_checkudata(StateToNative(m_state), 1, m_metatableName.c_str()));
