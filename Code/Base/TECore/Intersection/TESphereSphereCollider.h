...
namespace TE::Intersection {
  ...
  /**
   *	\brief		SphereSphereCollider class. Checks for collision between two
   *bounding volumes. \author		Terje Loe \version	1.00 - 10/08/10 - Initial
   *version \date		10/08/10
   */
  struct SphereSphereCollider {
    static bool Collide(const BSphere &bsphere0,
