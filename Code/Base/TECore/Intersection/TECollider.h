...
namespace TE::Intersection {
    ...
    class Collider {
      public:
         ...
         *	\return
         */
        Collider(bool coarse,
                 bool symetric,
                 Real dt                             = Math::Base<Real>::REAL_ZERO,
        ...
        /**
         *  \brief		virtual. executes the collision test returns true if there is a
        ...
        ContactSet GetContactSet() { return m_contacts; }
